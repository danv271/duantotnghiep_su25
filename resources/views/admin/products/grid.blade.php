                         ...
                         <div class="col-lg-3">
                              ...
                              <div class="card">
                                   <div class="card-body border-light">
                                        <a href="product-grid.html#" class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0" data-bs-toggle="collapse" data-bs-target="#categories" aria-expanded="false" aria-controls="other">Categories
                                        ...
                                        <div class="mt-4">
                                             <a href="product-grid.html#" class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0" data-bs-toggle="collapse" data-bs-target="#price" aria-expanded="false" aria-controls="other">Product Price
                                                  <i class='bx bx-chevron-down ms-auto fs-20'></i>
                                             </a>
                                        ...
                                        <div class="mt-4">
                                             <a href="product-grid.html#" class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0" data-bs-toggle="collapse" data-bs-target="#gender" aria-expanded="false" aria-controls="other">Gender
                                                  <i class='bx bx-chevron-down ms-auto fs-20'></i>
                                             </a>
                                        ...
                                        <div class="mt-4">
                                             <a href="product-grid.html#" class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0" data-bs-toggle="collapse" data-bs-target="#size" aria-expanded="false" aria-controls="other">Size & Fit
                                                  <i class='bx bx-chevron-down ms-auto fs-20'></i>
                                             </a>
                                             <div id="size" class="collapse show">
                                                  ...
                                                  <div class="categories-list d-flex flex-column gap-2 mt-2">
                                                       ...
                                                       <a href="product-grid.html#!" class="text-dark fw-medium">More</a>
                                                  </div>
                                             </div>
                                        </div>
                                        <div class="mt-3">
                                             <a href="product-grid.html#" class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0" data-bs-toggle="collapse" data-bs-target="#rating" aria-expanded="false" aria-controls="other">Rating
                                                  <i class='bx bx-chevron-down ms-auto fs-20'></i>
                                             </a>
                                   ...
                                   <div class="card-footer">
                                        <a href="product-grid.html#!" class="btn btn-primary w-100">Apply</a>
                                   </div>
                              </div>
                         </div>
                         <div class="col-lg-9">
                                             ...
                                             <div class="card-body bg-light-subtle rounded-bottom">
                                                  ...
                                                  <div class="mt-3">
                                                       <div class="d-flex gap-2">
                                                            <div class="dropdown">
                                                                 <a href="product-grid.html#" class="btn btn-soft-primary border border-primary-subtle" data-bs-toggle="dropdown" aria-expanded="false"><i class='bx bx-dots-horizontal-rounded'></i></a>
                                                                 <div class="dropdown-menu">
                                                                      <!-- item-->
                                                                      <a href="product-grid.html#!" class="dropdown-item">Edit</a>
                                                                      <!-- item-->
                                                                      <a href="product-grid.html#!" class="dropdown-item">Overview</a>
                                                                      <!-- item-->
                                                                      <a href="product-grid.html#!" class="dropdown-item">Delete</a>
                                                                 </div>
                                                            </div>
