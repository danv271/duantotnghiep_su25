                         ...
                         <div class="col-xl-12">
                              <div class="card">
                                   <div class="card-header d-flex justify-content-between align-items-center gap-1">
                                        ...
                                        <div class="dropdown">
                                             <a href="product-list.html#" class="dropdown-toggle btn btn-sm btn-outline-light" data-bs-toggle="dropdown" aria-expanded="false">
                                                  This Month
                                             </a>
                                             <div class="dropdown-menu dropdown-menu-end">
                                                  <!-- item-->
                                                  <a href="product-list.html#!" class="dropdown-item">Download</a>
                                                  <!-- item-->
                                                  <a href="product-list.html#!" class="dropdown-item">Export</a>
                                                  <!-- item-->
                                                  <a href="product-list.html#!" class="dropdown-item">Import</a>
                                             </div>
                                        </div>
                                   </div>
                                   <div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Black T-shirt</a>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <a href="product-list.html#!" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                                                      <a href="product-list.html#!" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                                                      <a href="product-list.html#!" class="btn btn-soft-danger btn-sm"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                                                 </div>
                                                            </td>
                                                       </tr>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Olive Green Leather Bag</a>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Women Golden Dress</a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M </p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Gray Cap For Men</a>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Dark Green Cargo Pent</a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M , L , Xl </p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Orange Multi Color Headphone</a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M </p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Kid's Yellow Shoes</a>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Men Dark Brown Wallet</a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M</p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Sky Blue Sunglass</a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M </p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Kid's Yellow T-shirt</a>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">White Rubber Band Smart Watch </a>
                                                                           <p class="text-muted mb-0 mt-1 fs-13"><span>Size : </span>S , M </p>
                                                                      </div>
                                                                 </div>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <div>
                                                                           <a href="product-list.html#!" class="text-dark fw-medium fs-15">Men Brown Leather Shoes </a>
