                     ...
                     <div class="col-lg-4">
                          <div class="card">
                               ...
                               <div class="card-footer border-top">
                                    <div class="row g-2">
                                         <div class="col-lg-5">
                                              <a href="product-details.html#!" class="btn btn-primary d-flex align-items-center justify-content-center gap-2 w-100"><i class="bx bx-cart fs-18"></i> Add To Cart</a>
                                         </div>
                                         <div class="col-lg-5">
                                              <a href="product-details.html#!" class="btn btn-light d-flex align-items-center justify-content-center gap-2 w-100"><i class="bx bx-shopping-bag fs-18"></i> Buy Now</a>
                                         </div>
                                         <div class="col-lg-2">
                     ...
                     <div class="col-lg-8">
                          <div class="card">
                               <div class="card-body">
                                    ...
                                    <p class="mb-1">
                                         <a href="product-details.html#!" class="fs-24 text-dark fw-medium">Men Black Slim Fit T-shirt</a>
                                    </p>
                                    ...
                                    <p class="text-muted">Top in sweatshirt fabric made from a cotton blend with a soft brushed inside. Relaxed fit with dropped shoulders, long sleeves and ribbing around the neckline, cuffs and hem. Small metal text applique. <a href="product-details.html#!" class="link-primary">Read more</a></p>
                     ...
                     <div class="col-lg-6">
                          <div class="card">
                               ...
                               <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                         <a href="product-details.html#!" class="link-primary text-decoration-underline link-offset-2">View More Details <i class="bx bx-arrow-to-right align-middle fs-16"></i></a>
                                    </div>
                               </div>
                          </div>
                     </div>
                     <div class="col-lg-6">
                          <div class="card">
                               ...
                               <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                         <a href="product-details.html#!" class="fs-14 me-3 text-muted"><i class='bx bx-like'></i> Helpful</a>
                                         <a href="product-details.html#!" class="fs-14 text-muted">Report</a>
                                    </div>
