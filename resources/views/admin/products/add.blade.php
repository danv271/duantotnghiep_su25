        ...
        <div class="col-xl-3 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h4 class="fw-semibold text-dark mt-2 d-flex align-items-center gap-2">
                            <span class="text-muted text-decoration-line-through">$100</span> $80 <small class="text-muted">
                                (30% Off)</small>
                        </h4>
                        <div class="mt-3">
                ...
                <div class="card-footer bg-light-subtle">
                    <div class="row g-2">
                        <div class="col-lg-6">
                            <a href="product-add.html#!" class="btn btn-outline-secondary w-100">Create Product</a>
                        </div>
                        <div class="col-lg-6">
                            <a href="product-add.html#!" class="btn btn-primary w-100">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
