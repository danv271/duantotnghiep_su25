            ...
            <div class="position-relative ms-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 border-end border-light">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="javascript:void(0);" class="text-dark fw-medium">Concept.fig</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center gap-2">
                                            <i class="bx bxl-file-doc fs-20 text-success"></i>
                                            <a href="javascript:void(0);" class="text-dark fw-medium">larkon.docs</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center gap-3 mt-1 bg-light bg-opacity-50 p-2 rounded-2">
                                <a href="javascript:void(0);" class="fw-medium text-dark">UI/UX Figma Design</a>
                                <div class="ms-auto">
                                    <a href="javascript:void(0);" class="fw-medium text-primary fs-18" data-bs-toggle="tooltip" data-bs-title="Download" data-bs-placement="bottom"><iconify-icon icon="iconamoon:cloud-download-duotone"></iconify-icon></a>
                                </div>
                            </div>
                ...
                <div class="position-relative ps-4">
                    <div class="mb-4">
                        ...
                        <div class="ms-2">
                            <h5 class="mb-1 text-dark fw-semibold fs-15">Larkon Application UI v2.0.0 <span class="badge bg-primary-subtle text-primary px-2 py-1 ms-1">Latest</span></h5>
                            <p>Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
                            <div class="mt-2">
                                <a href="javascript:void(0);" class="btn btn-light btn-sm">Download Zip</a>
                            </div>
