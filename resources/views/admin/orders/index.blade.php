...
@section('page-title', 'Trang Đơn Hàng ')
...
@section('content')
                            ...
                            <div class="d-flex card-header justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <!-- item-->
                                        <a href="orders-list.html#!" class="dropdown-item">Download</a>
                                        <!-- item-->
                                        <a href="orders-list.html#!" class="dropdown-item">Export</a>
                                        <!-- item-->
                                        <a href="orders-list.html#!" class="dropdown-item">Import</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-middle mb-0 table-hover table-centered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Apr 23 , 2024</td>
                                                <td>
                                                    <a href="orders-list.html#!" class="link-primary fw-medium">Gail C.
                                                        Anderson</a>
                                                </td>
                                                <td> Normal</td>
                                                <td> $1,230.00</td>
                                                <td> <span class="badge bg-light text-dark  px-2 py-1 fs-13">Unpaid</span>
                                                </td>
                                                <td> 4</td>
                                                <td> -</td>
                                                <td>
                                                    <span id="showStatusForm"
                                                        class="badge border border-secondary text-secondary px-2 py-1 fs-13"
                                                        onclick="showStatusForm()">Draft</span>
                                                </td>
                                                <td>
            ...
            <div class="modal fade" id="statusModal" tabindex="-1" aria-labelledby="statusModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="statusForm" action="/update-status" method="POST">
    ...
    // Đặt giá trị order_id vào input hidden
    var showForm = document.getElementById('showStatusForm');
